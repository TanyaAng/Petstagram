...
def create_profile(request):
    return crud_action(request, CreateProfileForm, 'index', Profile(), 'profile_create.html')
    # if request.method == 'POST':
...
def edit_profile(request):
    return crud_action(request, EditProfileForm, 'profile', get_profile(), 'profile_edit.html')
    # profile = get_profile()
    # if request.method == 'POST':
...
def delete_profile(request):
    return crud_action(request, DeleteProfileForm, 'index', get_profile(), 'profile_delete.html')
